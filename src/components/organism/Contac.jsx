...
export default function Contac() {
  ...
  return (
    <section className="bg-slate-50 px-6 py-20 text-slate-900" id="contac">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mb-12 text-lg font-medium text-slate-600">
          Estoy disponible para nuevas oportunidades y colaboraciones en{" "}
          <span className="font-bold text-slate-900">SIGACE</span> o cualquier
          idea digital.
        </p>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {socialLinks.map((social, index) => (
            ...
            >
              <div className="mb-4 inline-block rounded-2xl bg-slate-100 p-4 transition-colors group-hover:bg-white">
        ...
        <div className="mt-16 rounded-3xl border border-slate-200 bg-white p-10 shadow-2xl shadow-slate-200/50">
          ...
          <a
            ...
            className="inline-block rounded-2xl bg-slate-900 px-12 py-4 font-bold text-white shadow-lg shadow-slate-300 transition-all hover:bg-cyan-600"
          >
            Enviar Email
          </a>
        </div>
